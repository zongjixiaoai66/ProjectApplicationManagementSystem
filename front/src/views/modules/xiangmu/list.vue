        ...
        <el-dialog title="审核" :visible.sync="xiangmuYesnoTypesVisible">
            <el-form :model="form">
                ...
                <el-form-item label="审核" >
                    <el-select v-model="form.xiangmuYesnoTypes" placeholder="请选择申请状态">
        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '所属方向' : ''">
                        <el-select v-model="searchForm.yanjiufangxiangTypes" placeholder="请选择所属方向">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '申请状态' : ''">
                        <el-select v-model="searchForm.xiangmuYesnoTypes" placeholder="请选择申请状态">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xiangmushenbao/upload/xiangmuMuBan.xls"
                        >批量导入项目数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('xiangmu','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="yanjiufangxiangFile"
                                     header-align="center"
                                     width="200"
                                     label="附件">
                        <template slot-scope="scope">
                            <div v-if="scope.row.yanjiufangxiangFile">
                                <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+scope.row.yanjiufangxiangFile">下载</a>
                            </div>
                            <div v-else>无文件</div>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="xiangmuShenheTime"
                                   header-align="center"
                                   label="审核时间">
                        <template slot-scope="scope">
                            {{scope.row.xiangmuShenheTime}}
                        </template>
                    </el-table-column>
...
<script>
    ...
    //当前表下拉框搜索条件
            ...
            form:{
                ...
                yanjiufangxiangFile : null,
                xiangmuContent : null,
                xiangmuChengguoContent : null,
                insertTime : null,
                xiangmuYesnoTypes : null,
                xiangmuYesnoText : null,
                xiangmuShenheTime : null,
                createTime : null,
            },
            dataList: [],
            pageIndex: 1,
            ...
            json_fields: {
                ...
                //本表字段
                     ...
                     '项目结束时间': "jieshuTime",
                     '项目花费': "huafeiJine",
                     '所属方向': "yanjiufangxiangValue",
                     '附件': "yanjiufangxiangFile",
                     '申请时间': "insertTime",
                     '申请状态': "xiangmuYesnoValue",
        ...
        methods: {
            ...
            openYesnoTypes(id) {
                ...
                _this.form.xiangmuYesnoTypes = "请选择申请状态";
                _this.xiangmuYesnoTypesVisible = true;
            },

            xiangmuYesnoTypesShenhe() {
                let _this = this;
                if(_this.form.xiangmuYesnoTypes == "请选择申请状态"){

    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">项目申报管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <el-form-item label="评审专家姓名" class="input" v-if="tableName=='pingshenzhuanjia'">
                            <el-input v-model="ruleForm.pingshenzhuanjiaName" autocomplete="off" placeholder="评审专家姓名"  />
                        </el-form-item>
                        <el-form-item label="评审专家手机号" class="input" v-if="tableName=='pingshenzhuanjia'">
                            <el-input v-model="ruleForm.pingshenzhuanjiaPhone" autocomplete="off" placeholder="评审专家手机号"  />
                        </el-form-item>
                        <el-form-item label="评审专家身份证号" class="input" v-if="tableName=='pingshenzhuanjia'">
                            <el-input v-model="ruleForm.pingshenzhuanjiaIdNumber" autocomplete="off" placeholder="评审专家身份证号"  />
                        </el-form-item>
                        <el-form-item label="电子邮箱" class="input" v-if="tableName=='pingshenzhuanjia'">
                            <el-input v-model="ruleForm.pingshenzhuanjiaEmail" autocomplete="off" placeholder="电子邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.pingshenzhuanjiaName)&& 'pingshenzhuanjia'==this.tableName){
                                this.$message.error('评审专家姓名不能为空');
                                return
                            }
                             if('pingshenzhuanjia' == this.tableName && this.ruleForm.pingshenzhuanjiaPhone&&(!this.$validate.isMobile(this.ruleForm.pingshenzhuanjiaPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if((!this.ruleForm.pingshenzhuanjiaIdNumber)&& 'pingshenzhuanjia'==this.tableName){
                                this.$message.error('评审专家身份证号不能为空');
                                return
                            }
                            if('pingshenzhuanjia' == this.tableName && this.ruleForm.pingshenzhuanjiaEmail&&(!this.$validate.isEmail(this.ruleForm.pingshenzhuanjiaEmail))){
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/xiangmushenbao/img/back-img-bg.jpg);

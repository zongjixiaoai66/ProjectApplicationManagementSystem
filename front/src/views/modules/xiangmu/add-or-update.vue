        ...
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="项目开始时间" prop="kaishiTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.kaishiTime" label="项目开始时间" prop="kaishiTime">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="项目结束时间" prop="jieshuTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jieshuTime" label="项目结束时间" prop="jieshuTime">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="项目花费" prop="huafeiJine">
                       <el-input v-model="ruleForm.huafeiJine"
                                 placeholder="项目花费" clearable  :readonly="ro.huafeiJine"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="项目花费" prop="huafeiJine">
                           <el-input v-model="ruleForm.huafeiJine"
                                     placeholder="项目花费" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="所属方向" prop="yanjiufangxiangTypes">
                        <el-select v-model="ruleForm.yanjiufangxiangTypes" :disabled="ro.yanjiufangxiangTypes" placeholder="请选择所属方向">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="所属方向" prop="yanjiufangxiangValue">
                        <el-input v-model="ruleForm.yanjiufangxiangValue"
                            placeholder="所属方向" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.yanjiufangxiangFile" label="附件" prop="yanjiufangxiangFile">
                        <file-upload
                                tip="点击上传附件"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.yanjiufangxiangFile?$base.url+ruleForm.yanjiufangxiangFile:''"
                                @change="yanjiufangxiangFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.yanjiufangxiangFile" label="附件" prop="yanjiufangxiangFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.yanjiufangxiangFile"  >附件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="项目内容" prop="xiangmuContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.xiangmuContent" label="项目内容" prop="xiangmuContent">
                            <span v-html="ruleForm.xiangmuContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="项目成果" prop="xiangmuChengguoContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.xiangmuChengguoContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.xiangmuChengguoContent" label="项目成果" prop="xiangmuChengguoContent">
                            <span v-html="ruleForm.xiangmuChengguoContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.xiangmuYesnoTypes" label="申请状态" prop="xiangmuYesnoTypes">
                        <el-input v-model="ruleForm.xiangmuYesnoValue" placeholder="申请状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.xiangmuYesnoText" label="审核意见" prop="xiangmuYesnoText">
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.xiangmuShenheTime" label="审核时间" prop="xiangmuShenheTime">
                        <span v-html="ruleForm.xiangmuShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    yanjiufangxiangFile: false,
                    xiangmuContent: false,
                    xiangmuChengguoContent: false,
                    insertTime: false,
                    xiangmuYesnoTypes: false,
                    xiangmuYesnoText: false,
                    xiangmuShenheTime: false,
                },
                ruleForm: {
                    yonghuId: '',
                ...
                rules: {
                   ...
                   huafeiJine: [
                              { required: true, message: '项目花费不能为空', trigger: 'blur' },
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.xiangmuChengguoContent = _this.ruleForm.xiangmuChengguoContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        ...
                        this.ruleForm.xiangmuChengguoContent = this.ruleForm.xiangmuChengguoContent.replaceAll(this.$base.url,"");
                        this.$http({
            ...
            //图片
            yanjiufangxiangFileUploadChange(fileUrls){
                this.ruleForm.yanjiufangxiangFile = fileUrls;
                this.addEditUploadStyleChange()
            },
